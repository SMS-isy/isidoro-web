...
<head>
    ...
    <title>Informazioni PHP - MATTEO ISIDORO</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per MATTEO ISIDORO</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> MATTEO ISIDORO</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> isidoro.matteo</p>
